"""
Django settings for vehimarket project.
...
SECRET_KEY = 'django-insecure-g^4i+=jb-@2gvi_u_xuc3g+-nxcf$ys#o&gyy(1my&p+*=$l0k'
...
WSGI_APPLICATION = 'vehimarket.wsgi.application'
